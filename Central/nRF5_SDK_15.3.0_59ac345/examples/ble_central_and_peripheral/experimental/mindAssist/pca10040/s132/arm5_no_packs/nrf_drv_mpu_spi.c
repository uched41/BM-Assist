...
#define MPU_SPI_MOSI_PIN    ACCEL_SDA_PIN  // MPU SDI. 'SDA' on MPU breakout board silk screen
#define MPU_SPI_SCL_PIN     ACCEL_SCL_PIN  // MPU SCLK. 'SCL' on MPU breakout board silk screen
